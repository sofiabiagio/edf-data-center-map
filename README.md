...
- `docs/` — publication audit, domain cautions, and browser QA matrix.
...
See `docs/map-publication-audit.md` and `docs/domain-brief.md` for details.
...
limit. Record desktop/mobile browser QA and cold-load measurements using the
matrix in `docs/map-ux-design-plan.md` before announcing the public URL.

## Ownership

Maintainer: EDF project team. Use repository issues for data corrections,
publication questions, and operational incidents; replace this line with the
named owner or team alias before launch.
